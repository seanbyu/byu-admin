    ...
    <>
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pb-2">
          ...
          <div className="sticky bottom-0 bg-white/95 backdrop-blur -mx-6 px-6 py-3 border-t border-secondary-200 mt-6 flex flex-col-reverse sm:flex-row sm:justify-end gap-2 sm:gap-3">
